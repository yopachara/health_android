package com.yopachara.health.app;
...
/**
 * Created by yopachara on 2/6/2015.
 */
public class WeekView extends FrameLayout{
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes){
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, com.yopachara.health.demo.R.styleable.WeekView, defStyleAttr, defStyleRes);

        mVerticalPadding = a.getDimensionPixelOffset(com.yopachara.health.demo.R.styleable.WeekView_wv_verticalPadding, ThemeUtil.dpToPx(context, 8));
        mHorizontalPadding = a.getDimensionPixelOffset(com.yopachara.health.demo.R.styleable.WeekView_wv_horizontalPadding, ThemeUtil.dpToPx(context, 8));
        int animDuration = a.getInteger(com.yopachara.health.demo.R.styleable.WeekView_wv_animDuration, context.getResources().getInteger(android.R.integer.config_mediumAnimTime));
        mBackgroundColors = a.getColorStateList(com.yopachara.health.demo.R.styleable.WeekView_wv_backgroundColor);
